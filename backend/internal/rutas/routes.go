...
func SetupRoutes(
	...
	tipoTourGaleriaController *controladores.TipoTourGaleriaController,
) {
	// Middleware global
	...
	public := router.Group("/api/v1")
	{
		...
		public.GET("/tipos-tour/:idTipoTour/galeria", tipoTourGaleriaController.ListByTipoTour)
		public.GET("/galeria/:id", tipoTourGaleriaController.GetByID)
	}
	...
	protected.Use(middleware.AuthMiddleware(config))
	{
		...
		admin.Use(middleware.RoleMiddleware("ADMIN"))
		{
			...
			admin.GET("/tipos-tour/idioma/:idIdioma", tipoTourController.ListByIdioma)
		...
		vendedor.Use(middleware.RoleMiddleware("ADMIN", "VENDEDOR"))
		{
			...
			vendedor.GET("/tipos-tour/idioma/:idIdioma", tipoTourController.ListByIdioma)
		...
		cliente.Use(middleware.RoleMiddleware("ADMIN", "CLIENTE"))
		{
			...
			cliente.GET("/tipos-tour/idioma/:idIdioma", tipoTourController.ListByIdioma)
...
func SetupRoutes(
	...
	public := router.Group("/api/v1")
	{
		...
		// Galería de tipos de tour (acceso público)
		public.GET("/galeria/tipo-tour/:idTipoTour", tipoTourGaleriaController.ListByTipoTour)
		public.GET("/galeria/:id", tipoTourGaleriaController.GetByID)
	}
	...
	protected.Use(middleware.AuthMiddleware(config))
	{
		...
		admin.Use(middleware.RoleMiddleware("ADMIN"))
		{
			...
			// Gestión de galería de tipos de tour
			admin.POST("/galeria", tipoTourGaleriaController.Create)
			admin.GET("/galeria", tipoTourGaleriaController.List)
			admin.GET("/galeria/:id", tipoTourGaleriaController.GetByID)
			admin.PUT("/galeria/:id", tipoTourGaleriaController.Update)
			admin.DELETE("/galeria/:id", tipoTourGaleriaController.Delete)
			admin.DELETE("/galeria/:id/hard", tipoTourGaleriaController.HardDelete)
			admin.GET("/galeria/tipo-tour/:idTipoTour", tipoTourGaleriaController.ListByTipoTour) // Ruta corregida
		...
		vendedor.Use(middleware.RoleMiddleware("ADMIN", "VENDEDOR"))
		{
			...
			// Ver galería de tipos de tour (solo lectura)
			vendedor.GET("/galeria", tipoTourGaleriaController.List)
			vendedor.GET("/galeria/:id", tipoTourGaleriaController.GetByID)
			vendedor.GET("/galeria/tipo-tour/:idTipoTour", tipoTourGaleriaController.ListByTipoTour) // Ruta corregida
		...
		chofer.Use(middleware.RoleMiddleware("ADMIN", "CHOFER"))
		{
			...
			// Ver galería de tipos de tour (solo lectura)
			chofer.GET("/galeria/tipo-tour/:idTipoTour", tipoTourGaleriaController.ListByTipoTour) // Ruta corregida
			chofer.GET("/galeria/:id", tipoTourGaleriaController.GetByID)
		...
		cliente.Use(middleware.RoleMiddleware("ADMIN", "CLIENTE"))
		{
			...
			// Ver galería de tipos de tour (solo lectura)
			cliente.GET("/galeria/tipo-tour/:idTipoTour", tipoTourGaleriaController.ListByTipoTour) // Ruta corregida
			cliente.GET("/galeria/:id", tipoTourGaleriaController.GetByID)
