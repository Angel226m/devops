...
type Reserva struct {
	...
	CantidadPasajes []PasajeCantidad       `json:"cantidad_pasajes,omitempty" db:"-"`
	Paquetes        []PaquetePasajeDetalle `json:"paquetes,omitempty" db:"-"`
	MetodoPago      string                 `json:"metodo_pago,omitempty" db:"-"`
	TotalPasajeros  int                    `json:"total_pasajeros,omitempty" db:"-"`
}
...
type PasajeCantidad struct {
	...
	Subtotal       float64 `json:"subtotal,omitempty" db:"-"`
}
...
type NuevaReservaRequest struct {
	...
	TotalPagar      float64                 `json:"total_pagar" validate:"required,min=0"`
	Notas           string                  `json:"notas"`
	CantidadPasajes []PasajeCantidadRequest `json:"cantidad_pasajes,omitempty"`
	Paquetes        []PaqueteRequest        `json:"paquetes,omitempty"`
}
...
type ReservaMercadoPagoRequest struct {
	...
	Telefono        string                  `json:"telefono"`
	Documento       string                  `json:"documento"`
	TourNombre      string                  `json:"tour_nombre"`
}
