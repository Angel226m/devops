...
const DetalleTour = () => {
  ...
  const { tipoTourActual, cargando, error } = useSelector(
      ...
      >
        ...
        {tabActiva === 'descripcion' && (
          <div className="prose prose-lg max-w-none">
            ...
            ) : typeof tipoTourActual.descripcion === 'object' && tipoTourActual.descripcion.Valid && tipoTourActual.descripcion.String.trim() !== '' ? (
              <div className="mt-4 pt-4 border-t border-gray-200">
                <h3 className="text-lg font-semibold mb-2">Descripción adicional:</h3>
