    ...
    >
      {error && (
        <motion.div 
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          className="bg-red-50 border-l-4 border-red-500 text-red-700 p-3 rounded-md text-sm mb-4"
        >
          <div className="flex items-center">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div>
          ...
          <input
            ...
            value={formData.correo}
            onChange={handleChange}
            className="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-all duration-300"
            placeholder="correo@ejemplo.com"
          />
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            ...
            <Link to="/recuperar-contrasena" className="text-sm text-blue-600 hover:text-blue-500 transition-colors duration-300">
              ¿Olvidaste tu contraseña?
            </Link>
          </div>
          <div className="relative">
            <input
              ...
              value={formData.contrasena}
              onChange={handleChange}
              className="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm pr-10 transition-all duration-300"
              placeholder="••••••"
            />
            <button
              type="button"
        ...
        <div>
          <button
            type="submit"
            disabled={cargando}
            className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 ease-in-out ${
              cargando ? 'opacity-70 cursor-not-allowed' : ''
            }`}
          >
            {cargando ? (
