    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50 via-white to-cyan-50">
      <div className="max-w-md w-full space-y-8">
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className="bg-white py-8 px-6 sm:px-10 shadow-xl sm:rounded-xl border border-blue-100"
        >
          {/* Reemplazamos el formulario original con una versión mejorada visualmente */}
          <FormularioIngresoMejorado />
...
// Formulario mejorado visualmente sin cambiar la funcionalidad
const FormularioIngresoMejorado = () => {
  const { t } = useTranslation();
      ...
      <div>
        ...
        <div className="relative rounded-md shadow-sm">
          ...
          <input
            ...
            autoComplete="email"
            required
            className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-3 py-2.5 sm:text-sm border-gray-300 rounded-md shadow-sm"
      ...
      <div>
        ...
        >
          <span className="absolute left-0 inset-y-0 flex items-center pl-3">
            <svg className="h-5 w-5 text-blue-100 group-hover:text-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
