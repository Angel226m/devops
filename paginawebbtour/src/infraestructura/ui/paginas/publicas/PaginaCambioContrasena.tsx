    ...
    return (
      <Seccion className="py-16 bg-gradient-to-b from-blue-50 via-sky-50 to-cyan-50 min-h-screen">
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-blue-100 text-center">
            <div className="animate-pulse flex justify-center py-8">
              <div className="h-12 w-12 rounded-full bg-blue-200"></div>
            </div>
            <p className="text-gray-600 text-sm leading-relaxed">{t('cambioContrasena.validandoToken')}</p>
          </div>
        </div>
      </Seccion>
    );
      ...
      <Seccion className="py-16 bg-gradient-to-b from-blue-50 via-sky-50 to-cyan-50 min-h-screen">
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-blue-100 text-center"
          >
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-red-100 mb-8 mx-auto">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
              </svg>
            </div>
