...
const PaginaPerfil = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        {/* Encabezado */}
        <div className="bg-gradient-to-r from-blue-600 to-indigo-500 text-white rounded-lg shadow-lg p-6 mb-6">
          <h1 className="text-2xl font-bold">{t('menu.perfil')}</h1>
          <p className="opacity-90">{t('perfil.gestionarCuenta')}</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
          ...
          {!editando ? (
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-sm font-medium text-gray-500">{t('perfil.nombres')}</h3>
                  <p className="mt-1 text-gray-900">{usuario.nombres}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">{t('perfil.apellidos')}</h3>
                  <p className="mt-1 text-gray-900">{usuario.apellidos}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">{t('perfil.correo')}</h3>
                  <p className="mt-1 text-gray-900">{usuario.correo}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">{t('perfil.telefono')}</h3>
                  <p className="mt-1 text-gray-900">{usuario.numero_celular || t('perfil.noRegistrado')}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">{t('perfil.documento')}</h3>
                  <p className="mt-1 text-gray-900">{usuario.numero_documento || t('perfil.noRegistrado')}</p>
                </div>
              </div>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="mt-6 flex justify-end">
                <button
                  type="button"
                  onClick={() => setEditando(false)}
                  className="mr-3 px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                >
                  {t('perfil.cancelar')}
                </button>
                <button
                  type="submit"
                  disabled={cargando}
                  className="inline-flex justify-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                >
                  {cargando ? (
                    <Cargador tamanio="sm" color="text-white" />
                  ) : (
