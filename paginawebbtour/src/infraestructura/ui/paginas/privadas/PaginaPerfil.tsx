...
const PaginaPerfil = () => {
  ...
  console.log("🎯 PaginaPerfil: Renderizando componente");
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    try {
      console.log("🚀 PaginaPerfil: Enviando cambio de contraseña", {
        id: usuario.id_cliente
      });
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <h2 className="text-xl font-medium text-gray-900">No has iniciado sesión</h2>
          <p className="mt-2 text-gray-600">Inicia sesión para ver tu perfil</p>
        </div>
      </div>
    );
  }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-blue-50 to-sky-50 p-5 rounded-xl shadow-sm border border-blue-100">
                    <div className="flex items-center mb-3">
                      ...
                      <h3 className="text-sm font-medium text-gray-700">Nombres</h3>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-sky-50 p-5 rounded-xl shadow-sm border border-blue-100">
                    <div className="flex items-center mb-3">
                      ...
                      <h3 className="text-sm font-medium text-gray-700">Apellidos</h3>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-sky-50 p-5 rounded-xl shadow-sm border border-blue-100">
                    ...
                    <p className="text-gray-900 font-medium text-lg">{usuario.numero_celular || 'No registrado'}</p>
                  </div>
              ...
              <form onSubmit={handleSubmit} className="p-8">
                ...
                <div className="mt-8 flex justify-end">
                  ...
                  <button
                    type="submit"
                    disabled={cargando}
                    className="inline-flex justify-center px-5 py-2.5 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all disabled:opacity-50"
                  >
                    {cargando ? (
