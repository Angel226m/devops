  ...
  try {
    ...
    if (datosReserva.reservaId) {
      ...
      try {
        ...
        // MODIFICACIÓN IMPORTANTE: Enviar los pasajes como string para evitar problemas de serialización
        const datosSerializados = {
          ...datosParaEnviar,
          pasajes: JSON.stringify(datosParaEnviar.pasajes),
          paquetes: JSON.stringify(datosParaEnviar.paquetes)
        };
