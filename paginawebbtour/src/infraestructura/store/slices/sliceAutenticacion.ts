...
// Acción asíncrona para registrar un cliente
export const registrarCliente = createAsyncThunk(
  "autenticacion/registrar",
  async (cliente: NuevoClienteRequest) => {
    return await repoCliente.registrar(cliente);
  }
);
...
const autenticacionSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(registrarCliente.fulfilled, (state) => {
