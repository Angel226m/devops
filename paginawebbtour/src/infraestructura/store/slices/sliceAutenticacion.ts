...
// ✅ CAMBIO:  Eliminar token y refreshToken del estado
export interface EstadoAutenticacion {
  usuario: ClienteAutenticado | null;
  cargando: boolean;
  cargandoAutenticacion: boolean;
...
export const refrescarToken = createAsyncThunk(
  "autenticacion/refrescarToken",
  // ✅ CAMBIO:  No pasar refreshToken como parámetro
  async () => {
    return await repoCliente.refrescarToken();
  }
);
...
// ✅ ELIMINAR DE LAS EXPORTACIONES:
// establecerToken, establecerRefreshToken
export const { 
  establecerUsuario, 
  limpiarError,
  finalizarCargaAutenticacion,
