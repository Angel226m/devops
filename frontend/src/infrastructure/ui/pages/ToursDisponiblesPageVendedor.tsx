...
import { FaShip, FaClock, FaUserFriends, FaMoneyBillWave, FaCalendarAlt, FaSearch, FaMapMarkerAlt, FaCalendarCheck, FaTicketAlt, FaBox, FaInfoCircle, FaSync, FaStar, FaEye, FaTimes, FaChevronRight } from 'react-icons/fa';
...
const ToursDisponiblesPage: React.FC = () => {
  ...
  // Información actual
  const currentDateTime = "2025-06-27 01:25:33";
  ...
  // Función mejorada para formatear fechas y quitar T00:00:00Z
  ...
  // Función para formatear hora (09:00 AM)
  ...
  // Calcular duración (2h)
  const calcularDuracion = (instancia: InstanciaTour): string => {
    // Intenta primero con la duración en minutos del tipo de tour
  ...
  // Renderizar fecha corta (selector de fechas)
  ...
  const DetallesModal = () => {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm" onClick={handleCloseModal}>
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-sm">{formatearHora(instancia.hora_inicio)}</p>
                      </div>
                    </div>
                    <div className="flex items-center">
