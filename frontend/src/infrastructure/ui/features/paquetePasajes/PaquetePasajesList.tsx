...
import { FiPlus, FiFilter, FiEdit2, FiTrash2, FiRefreshCcw, FiPackage, FiEye, FiMapPin, FiDollarSign } from 'react-icons/fi';
...
const PaquetePasajesList: React.FC = () => {
  ...
  const handleFilterChange = () => {
    if (selectedSedeFilter && selectedSedeFilter !== '') {
      dispatch(fetchPaquetesPasajesBySede(parseInt(selectedSedeFilter)));
    } else if (selectedTipoTourFilter && selectedTipoTourFilter !== '') {
      dispatch(fetchPaquetesPasajesByTipoTour(parseInt(selectedTipoTourFilter)));
    } else {
      dispatch(fetchPaquetesPasajes());
    }
  };
  ...
  return (
    <Card className="w-full">
      ...
      <div className="px-6 py-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="relative">
              ...
              <Select
                ...
                onChange={(e) => setSelectedTipoTourFilter(e.target.value)}
                className="pl-10"
              >
        ...
        {paquetesPasajes.length === 0 ? (
          renderEmptyState()
        ) : (
          <Table
            columns={columns}
            data={paquetesPasajes}
            loading={loading}
