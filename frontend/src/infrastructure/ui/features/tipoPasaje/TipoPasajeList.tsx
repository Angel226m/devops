...
import { FiPlus, FiTag, FiEdit2, FiTrash2, FiRefreshCcw, FiMapPin, FiDollarSign, FiEye, FiUsers } from 'react-icons/fi';
...
const TipoPasajeList: React.FC = () => {
  ...
  const handleFilterChange = () => {
    if (selectedSedeFilter && selectedSedeFilter !== '') {
      dispatch(fetchTiposPasajeBySede(parseInt(selectedSedeFilter)));
    } else if (selectedTipoTourFilter && selectedTipoTourFilter !== '') {
      dispatch(fetchTiposPasajeByTipoTour(parseInt(selectedTipoTourFilter)));
    } else {
      dispatch(fetchTiposPasaje());
    }
  };
